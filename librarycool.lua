...
function Luxt.CreateWindow(libName)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.Text = tabText
        tabBtn.TextColor3 = Color3.fromRGB(250, 250, 250)
        ...
        tabLogo.ImageColor3 = Color3.fromRGB(250, 250, 250)
        --
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(250, 250, 250)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(250, 250, 250)
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    checkBtn.MouseButton1Click:Connect(function()
                        if not togDe then
                            ...
                            callback(on)
                            if on then
                                checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(250, 250, 250)
                                checkBtn.ImageColor3 = Color3.fromRGB(250, 250, 250)
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        key.Text = oldKey
                        key.TextColor3 = Color3.fromRGB(250, 250, 250)
                        key.TextSize = 14.000
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            TextBox.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                dragSlider.BackgroundColor3 = Color3.fromRGB(250, 250, 250)
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    expand_more.ImageColor3 = Color3.fromRGB(250, 250, 250)
                                    ...
                                    dropdownItem1.TextColor3 = Color3.fromRGB(250, 250, 250)
